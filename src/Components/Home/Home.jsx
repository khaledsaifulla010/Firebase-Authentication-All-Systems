    ...
    return (
        <div>
            <div className="w-[600px] h-[370px] border-2 ml-[490px] rounded-xl mt-24 bg-gradient-to-r from-cyan-500 to-blue-500">
                ...
                <div className=" w-[250px] p-8 border-4 mt-16 ml-[170px] rounded-xl">
                    <button className="bg-gradient-to-r from-violet-500 to-fuchsia-500 font-bold p-4 w-full text-xl rounded-xl text-white  ">Login</button>
                </div>
            </div>
        </div>
    );
